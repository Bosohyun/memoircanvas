...
void main() {
  ...
  group('SignInEvent', () {
    ...
    blocTest<AuthBloc, AuthState>(
      'should emit [AuthLoading, AuthSuccess] when '
      'signIn succeeds',
      build: () {
  ...
  group('SignUpEvent', () {
    blocTest<AuthBloc, AuthState>(
      'should emit [AuthLoading, SignedUp] when SignUpEvent is addes '
      'and signUp succeeds',
      build: () {
  ...
  group('ForgotPasswordEvent', () {
    blocTest<AuthBloc, AuthState>(
      'should emit [AuthLoading, ForgotPasswordSuccess] when ForgotPasswordEvent '
