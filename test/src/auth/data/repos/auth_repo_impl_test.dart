...
void main() {
  ...
  group('forgotPassword', () {
    ...
    test('should return [Failure] when call to remote source is unsuccessful',
        () async {
  ...
  group('signIn', () {
    test('should return [LocalUser] when call to remote source is successful',
        () async {
      when(
    ...
    test(
        'should return [ServerFailure] when call to remote sourece is '
        'unsuccessuful', () async {
      when(
        () => remoteDataSource.signIn(
          email: any(named: 'email'),
  ...
  group('updateUser', () {
    test('should return when call to remote source is successful', () async {
